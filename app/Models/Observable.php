...
protected $_observers = Array();
	 ...
	 * @version 1.0
	 */
	public function add($Observer, $action, $function = null)
	{
	 ...
	 * @version 1.0
	 */
	protected function _start($action, $params = Array(), $stopIfFalse = false)
	{	
		...
		$values = Array();
			...
			for($i = 0; $i < count($this->_observers[$action]); $i++)
			{
				...
				array_unshift($params, $this->_observers[$action][$i]["obj"]);
					...
					else $values[] = call_user_func_array(array($this->_observers[$action][$i]["obj"], $action), $params);
	 ...
	 * @version 1.0
	 */
	public function fire($action, $params = Array())
	{
	 ...
	 * @version 1.0
	 */
	public function first($action, $params = Array())
	{
	$values = $this->_start($action, $params);
	 ...
	 * @version 1.0
	 */
	public function until($action, $params = Array())
	{
