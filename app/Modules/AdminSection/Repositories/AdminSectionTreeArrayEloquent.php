 ...
 * @version 1.0
 */
namespace App\Modules\AdminSection\Repositories;
 ...
 */
class AdminSectionTreeArrayEloquent extends AdminSectionTreeArray
{
use RepositaryEloquent;
    ...
    {
    return App::make('App\Modules\AdminSection\Repositories\AdminSection')->get($id, $active);
    }
	 ...
	 * @version 1.0
	 */
	public function read($filters = null, $active = null, $sorts = null, $offset = null, $limit = null, $with = null, $group = null)
	{
	return App::make('App\Modules\AdminSection\Repositories\AdminSection')->read($filters, $active, $sorts, $offset, $limit, $with, $group);
	}
    ...
    {
    return App::make('App\Modules\AdminSection\Repositories\AdminSection')->count($filters, $active, $with);
    }
	...
	$idAdminSection = $Model->createNode($data);
		...
		else Cache::tags(['AdminSectionItem'])->flush();

	return $idAdminSection;
	}
	...
	{
    $Model = App::make('App\Modules\AdminSection\Repositories\AdminSection');
	...
	public function tree($data, $isOpenType = true, $idCurrent = null, $idRoot = null, $idReferenRoot = null, $params = null)
	{
		...
		return Cache::tags(['AdminSection', 'AdminSectionItem', 'AdminSectionTreeArray'])->remember($cacheKey, $this->getCacheMinutes(),
