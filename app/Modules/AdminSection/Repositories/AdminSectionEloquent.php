 ...
 */
class AdminSectionEloquent extends AdminSection
{
use RepositaryEloquent;
    ...
    {
    return $this->_get(['AdminSection', 'AdminSectionItem'], $id, $active);
    }
    ...
    {
    return $this->_read(['AdminSection', 'AdminSectionItem'], false, $filters, $active, $sorts, $offset, $limit, $with, $group);
    }
    ...
    {
    return $this->_read(['AdminSection', 'AdminSectionItem'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
    return $this->_create(['AdminSectionItem'], $data);
    }
    ...
    {
    return $this->_update(['AdminSectionItem'], $id, $data);
    }
    ...
    {
    return $this->_destroy(['AdminSectionItem'], $id);
    }
}