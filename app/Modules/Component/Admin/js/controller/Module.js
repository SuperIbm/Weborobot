Ext.define('Component.controller.Module',
	{
	...
	idOld: null,
		...
		control:
		{
			"Component\\.view\\.ModuleTree[name='ModuleTree'] tool[itemId='refresh']":
			{
			...
			"Component\\.view\\.ModuleTree[name='ModuleTree']":
			{
		...
		this.getGrid().getStore().load();
			...
			this.getGrid().setTitle("Компоненты: " + record.getData().text);
			...
			{
			this.getGrid().setTitle("Компоненты");
