Ext.define('Component.view.ComponentCreateForm',
	{
    extend: 'Ext.form.Panel',
	alias: 'widget.Component.view.ComponentCreateForm',
			...
			msgTarget: 'side',
                ...
                validator: function(value)
                {
                    if(Weborobot.Util.isLength(value, 1) == false)
                        return "Путь к архиву модуля должен быть определен! Допустимые форматы: *.zip";
                    else return true;
                }
            }
		]
