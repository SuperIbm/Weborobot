...
/**
 * Класс модель для таблицы комментариев публикации с построением дерева в виде массива на основе Eloquent.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 * @mixin \Eloquent
 */
class PublicationCommentTreeArrayEloquent extends PublicationCommentEloquent
{
use TreeArray;
