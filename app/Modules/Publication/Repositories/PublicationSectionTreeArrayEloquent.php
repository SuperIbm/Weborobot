...
/**
 * Класс репозитария разделов публикаций в виде древовидной структуры выдающий массив на основе Eloquent.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class PublicationSectionTreeArrayEloquent extends PublicationSectionTreeArray
{
use RepositaryEloquent;
    ...
    {
    return App::make('App\Modules\Publication\Repositories\PublicationSection')->get($id, $active);
    }
	...
	{
	return App::make('App\Modules\Publication\Repositories\PublicationSection')->read($filters, $active, $sorts, $offset, $limit, $with);
	}
    ...
    {
    return App::make('App\Modules\Publication\Repositories\PublicationSection')->count($filters, $active, $with);
    }
	...
	{
    $Model = App::make('App\Modules\Publication\Repositories\PublicationSection');
	...
	public function tree($data, $isOpenType = true, $idCurrent = null, $idRoot = null, $idReferenRoot = null, $params = null)
	{
		...
		return Cache::tags(['Publication', 'PublicationSection'])->remember($cacheKey, $this->getCacheMinutes(),
