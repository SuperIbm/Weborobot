...
/**
 * Класс репозитария компонента на основе Eloquent для публикаций.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class PublicationEloquent extends Publication
{
use RepositaryEloquent;
    ...
    {
    return $this->_get(['Publication', 'PublicationItem'], $id, $active);
    }
    ...
    {
    return $this->_read(['Publication', 'PublicationItem'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
    return $this->_read(['Publication', 'PublicationItem'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
    return $this->_create(['PublicationItem'], $data);
    }
    ...
    {
    return $this->_update(['PublicationItem'], $id, $data);
    }
