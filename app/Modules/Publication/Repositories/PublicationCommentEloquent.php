...
/**
 * Класс репозитария компонента на основе Eloquent для комментриев.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class PublicationCommentEloquent extends PublicationComment
{
use RepositaryEloquent;
    ...
    {
    return $this->_get(['Publication', 'PublicationComment'], $id, $active);
    }
    ...
    {
    return $this->_read(['Publication', 'PublicationComment'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
    return $this->_read(['Publication', 'PublicationComment'], true, $filters, $active, null, null, null, $with);
    }
