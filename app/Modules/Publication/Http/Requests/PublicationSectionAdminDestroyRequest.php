...
/**
 * Класс запрос для удаления раздела административной системы.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class PublicationSectionAdminDestroyRequest extends FormRequest
{
    /**
    ...
    public function attributes()
    {
        return
        [
        'idPublicationSection' => 'ID записи'
        ];
    }
