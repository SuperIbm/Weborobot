...
/**
 * Абстрактный класс построения репозитария для пользователей.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
abstract class User extends Repositary
{
    /**
	 ...
	 * @since 1.0
	 */
	abstract public function gates($id);


	/**
	 * Получение название уникального идентификатора для пользователя.
	 * @return array Вернет название идентификатора.
	 * @version 1.0
	 * @since 1.0
	 */
	 ...
	 * @return array Вернет название токена.
	 * @version 1.0
	 * @since 1.0
	 */
	abstract public function getRememberTokenName();
}