Ext.define('User.action.siteCreate.view.UserForm', 
	{
    extend: 'Ext.form.Panel',
	alias: 'widget.User.action.siteCreate.view.UserForm',
	...
	frame: false,
		...
		[
			...
			xtype: "comboBoxExt",
				...
				store: 
				{
				type: "User.action.siteCreate.store.ComponentTemplateSelect"	
				},
			...
			name: 'idPageConfirm',
			reference: "idPageConfirm",
			
			fieldLabel: 'Страница подтверждения:',
