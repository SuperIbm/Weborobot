      ...
      localization: /* alter these to change the text presented by the picker (e.g. different language) */
        {
          text:
          {
            title: 'Ведите указатель для выбора цвета',
            newColor: 'new',
          ...
          tooltips:
          {
            colors:
            {
              newColor: 'Новый цвет, нажмите &quot;OK&quot; чтобы принять его',
              currentColor: 'Нажмите отменить, чтобы вернуться к предыдущему цвету'
            },
            buttons:
            {
              ok: 'Принять выбранный цвет',
              cancel: 'Отменить и вернуться к предыдущему цвету'
            },
            hue:
            {
              radio: 'Установь оттенок цвета',
              textbox: 'Введите оттенок цвета со значением от 0 - 360&deg;'
            },
            saturation:
            {
              radio: 'Установите насыщенность цвета',
              textbox: 'Введите насыщенность цвета со значением от 0 - 100%'
            },
            value:
            {
              radio: 'Установите тон цвета',
              textbox: 'Введите тон цвета со значением от 0 - 100%'
            },
            red:
            {
              radio: 'Установите значение красного цвета',
              textbox: 'Введите значение красного цвета от 0 до 255'
            },
            green:
            {
              radio: 'Установите значение зеленого цвета',
              textbox: 'Введите значение зеленого цвета от 0 до 255'
            },
            blue:
            {
              radio: 'Установите значение синего цвета',
              textbox: 'Введите значение синиге цвета от 0 до 255'
            },
            alpha:
            {
              radio: 'Установите альфаканал цвета.',
              textbox: 'Введите альфаканал цвета от 0 до 100'
            },
            hex:
            {
              textbox: 'Установите шестнадцатеричное значение цвета (#000000-#ffffff)',
              alpha: 'Установите шестнадцатеричное значение цвета (#00-#ff)'
            }
          }
        }
    };
...
// Компонент для проектирования выбора цвета 
Ext.define("Admin.view.ux.ColorPicker",
	{
	extend: "Ext.form.field.Text",
	xtype: "colorpicker",
	alias: 'widget.colorpicker',
	
	invalidText: "Это некорректный цвет, он должен быть шестнадцатеричного формата (состоящий из 3 или 6 символов от 0 до 9 или от A до F)!",
	clientPath: 'component/Admin/admin/images/jPicker/',
	maskRe: /[#a-f0-9]/i,
		...
		triggers:
		{
			...
			cls: 'x-form-select-trigger',
				...
				var color = this._parseColor(this.getValue());
