 ...
 * @version 1.0
 */
namespace App\Modules\Infoblock\Http\Requests;

use App\Models\FormRequest;

/**
 * Класс запрос для удаления инфоблока.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class InfoblockAdminDestroyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return
        [
        'idInfoblock' => 'required|integer|digits_between:1,20'
        ];
    }
