        ...
        if(!$module)
        {
            ...
            $idAdminSection = \DB::table('adminSection')->insertGetId(
                array (
                    ...
                    'bundle' => 'MANEGER',
                    'iconSmall' => 'engine/app/Modules/ModuleTemplate/Admin/images/icon_small.png',
                    'iconBig' => 'engine/app/Modules/ModuleTemplate/Admin/images/icon_big.png',
                    'menuLeft' => 0,
                    'pathToCss' => 'engine/app/Modules/ModuleTemplate/Admin/css/main.css',
                    'pathToJs' => 'engine/app/Modules/ModuleTemplate/Admin/js/index.js',
                    'weight' => 2,
                    'status' => 1,
                )
            );
