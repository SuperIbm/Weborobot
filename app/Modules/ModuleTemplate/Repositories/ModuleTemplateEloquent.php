 ...
 * @version 1.0
 */
namespace App\Modules\ModuleTemplate\Repositories;

use App\Models\RepositaryEloquent;

/**
 * Класс репозитария шаблонов модулей на основе Eloquent.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class ModuleTemplateEloquent extends ModuleTemplate
{
use RepositaryEloquent;
    ...
    {
    return $this->_get(['ModuleTemplate', 'ModuleTemplateItem'], $id, $active);
    }
	...
	{
    return $this->_read(['ModuleTemplate', 'ModuleTemplateItem'], false, $filters, $active, $sorts, $offset, $limit, $with);
	}
    ...
    {
    return $this->_read(['ModuleTemplate', 'ModuleTemplateItem'], true, $filters, $active, null, null, null, $with);
    }
	...
	{
    return $this->_create(['ModuleTemplateItem'], $data);
	}
	...
	{
    return $this->_update(['ModuleTemplateItem'], $id, $data);
	}
	...
	{
    return $this->_destroy(['ModuleTemplateItem'], $id);
	}
}