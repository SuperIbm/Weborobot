 ...
 * @version 1.0
 */
namespace App\Modules\ModuleTemplate\Http\Requests;

use App\Models\FormRequest;

/**
 * Класс запрос для удаления шаблонов модуля.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class ModuleTemplateAdminDestroyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return
        [
        'idModuleTemplate' => 'required|integer|digits_between:1,20'
        ];
    }
