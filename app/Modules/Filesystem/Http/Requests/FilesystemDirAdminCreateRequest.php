...
/**
 * Класс запрос для создания директорий.
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 * @author Инчагов Тимофей Александрович.
 */
class FilesystemDirAdminCreateRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return
        [
        'path' => 'Поле :attribute должно содержать ссылку на папку для создания.',
